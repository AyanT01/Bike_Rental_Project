...
class BikeRental:
    ...
    def return_bikes(self,requests):
        """Returning bikes based on several parameters gotten from the user."""
...
class Customer:
    def __init__(self):
        """Initialize the attributes for the customer"""
        self.__bikes = 0
    ...
    def request_bikes(self):
        """Requesting bike from the system"""
